...
def define_input(define_io, define_fit, define_output, define_plots, define_intpol):
    ...
    xmlfilename = "input_KIC9635649.xml"
    ...
    define_io["asciifile"] = os.path.join("data", "KIC9635649.ascii")
    define_io["params"] = (
        "starid",
        "RA",
        "DEC",
    ...
    define_fit["priors"] = {"Teff": {"sigmacut": "3"}, 
                            "FeH": {"abstol": "0.5"},
                            "logg": {"sigmacut": "3"},}
    ...
    define_output["outparams"] = ("Teff", "FeH", "logg", "dnufit", "numax", "radPhot", "massfin", "age")
